...
require_once './BACKEND/clases/AccesoDatos.php'; # Contiene strings de coneccion a la base de datos
require_once './BACKEND/clases/ApiRest.php'; # Contiene todas mis clases y funciones
...
$app->group('/empleado',function(){
    ...
    $this->get('/login/{legajo},{clave}', \Usuario::class . '::Login'); //OJO SOLO EN LA BARRA DE DIRECCIONES, NO EN PARAMS
    //Ejemplo: http://localhost/PROGRAMACION/HTML/APICSS/empleado/login/789,1234
    $this->post('/update', \Usuario::class . '::ModificadoDeUsuarios');
